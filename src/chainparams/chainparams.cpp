...
class CIridiumParams : public CMainParams {
public:
    CIridiumParams() {    };
    
    void SetFixedParams(const char *NetworkName)
    {
        networkID = CBaseChainParams::IRIDIUM;
...
//        convertSeed6(vFixedSeeds, pnSeed6_test, ARRAYLEN(pnSeed6_test));
    ...
    void SetIridiumParam(const char*param_name,int64_t value)
    {
...
static CIridiumParams multiChainParams;


bool SelectIridiumParams(const char *NetworkName)
{
    SelectIridiumBaseParams(NetworkName,(int)mc_gState->m_NetworkParams->GetInt64Param("defaultrpcport"));
...
void SetIridiumParams()
{
    multiChainParams.SetIridiumParams();
}

void SetIridiumParam(const char*param_name,int64_t value)
{
    multiChainParams.SetIridiumParam(param_name,value);
}


void SetIridiumRuntimeParams()
{
    multiChainParams.SetIridiumRuntimeParams();
}

bool InitializeIridiumParams()
{
