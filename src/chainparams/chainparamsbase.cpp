...
class CBaseIridiumParams : public CBaseTestNetParams
{
public:
    CBaseIridiumParams()
    {
...
static CBaseIridiumParams multiChainParams;
/* MCHN END */      
...
bool SelectIridiumBaseParams(const char *NetworkName,int RPCPort)
{
